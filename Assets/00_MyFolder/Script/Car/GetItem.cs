...
public class GetItem : MonoBehaviour
{
    ...
    [SerializeField] private float initialForceStrength = 30000f; // 初期値1500に適切
    ...
    [SerializeField] private float cameraAdjustmentMultiplier = 2.0f; // カメラ倍率（累積）
    private int itemsPerCameraAdjustment = 5; // 5個ごとに調整

    [Header("Score UI Settings")]
    [SerializeField] private GameObject scoreUIPrefab;   // スコアUIのプレハブ
    [SerializeField] private Transform spawnParent;      // 親（Canvasなど）
